    ...
    $params = array(
                    ...
                    , 'items' => array(
                                        array(
                                            ...
                                            , 'icon' => ''
                                            , 'font_icon' => 'wpbc_icn_refresh'											//FixIn: 9.0.1.4	'glyphicon glyphicon-refresh'  // glyphicon-white
                                        ...
                                        , array(
                                            ...
                                            , 'style' => ''  //
                                            , 'icon' => ''
                                            , 'font_icon' => 'wpbc_icn_close'											//FixIn: 9.0.1.4	'wpbc_icn_close'
                                            , 'icon_position' => 'left'
                                            , 'attr' => array()
...
function wpbc_toolbar_filter__sort(){
        ...
        $selectors = array(
                            __('ID' ,'booking') . '&nbsp;<i class="wpbc_icn_north "></i>' => '',
    ...
    $params = array(
                    ...
                    , 'items' => array(
                                        array(
                                            ...
                                            , 'class' => 'button-primary'                 // button-secondary  | button-primary
                                            , 'icon' => ''
                                            , 'font_icon' => 'wpbc_icn_check_circle_outline glyphicon-white'
                                            , 'icon_position' => 'right'     // Position  of icon relative to Text: left | right
                                            , 'style' => ''                 // Any CSS class here
                                            , 'mobile_show_text' => true       // Show  or hide text,  when viewing on Mobile devices (small window size).
                                            , 'attr' => array()
        ...
        $params = array(
                        ...
                        , 'items' => array(
                                            array(
                                                ...
                                                , 'class' => ''                        // button-secondary  | button-primary
                                                , 'icon' => ''
                                                , 'font_icon' => 'wpbc_icn_delete_forever'
                                                , 'icon_position' => 'right'     // Position  of icon relative to Text: left | right
                                                , 'style' => ''                 // Any CSS class here
                                                , 'mobile_show_text' => true       // Show  or hide text,  when viewing on Mobile devices (small window size).
                                                , 'attr' => array()
    ...
    $params = array(
                    ...
                    , 'items' => array(
                                        array(
                                            ...
                                            , 'class' => ''                 // button-secondary  | button-primary
                                            , 'icon' => ''
                                            , 'font_icon' => 'wpbc_icn_disabled_visible'
                                            , 'icon_position' => 'right'     // Position  of icon relative to Text: left | right
                                            , 'style' => ''                 // Any CSS class here
                                            , 'mobile_show_text' => true       // Show  or hide text,  when viewing on Mobile devices (small window size).
                                            , 'attr' => array()
                                        ...
                                        , array(
                                            ...
                                            , 'class' => ''                 // button-secondary  | button-primary
                                            , 'icon' => ''
                                            , 'font_icon' => 'wpbc_icn_visibility_off'
                                            , 'icon_position' => 'right'     // Position  of icon relative to Text: left | right
                                            , 'style' => ''                 // Any CSS class here
                                            , 'mobile_show_text' => true       // Show  or hide text,  when viewing on Mobile devices (small window size).
                                            , 'attr' => array()

		...
		private function show_booking_title_for_timeline( $bookings_in_cell, $row_settings ){
			...
			foreach ( $bookings_in_cell as $booking_id ) {
				...
				if ( $is_show_popover_in_timeline ) {
					...
					$popup_content_arr[] = '<div class="popover-title">' . $popup_content['title'] . '</div><div class="popover-content">' .   $popup_content['content'] . '</div>';
				}
				...
				if ( ( ! $this->is_frontend ) && ( $is_can ) ) {
					...
					if ( class_exists( 'wpdev_bk_personal' ) ) {
						...
						if ( ( ! $is_approved ) || ( 'On' != $is_change_hash_after_approvement ) ) {                                                                 //FixIn: 8.2.1.14
							...
							$header_title .= '<a class=\'btn btn-default wpbc_btn_in_timeline\' title=\''. esc_js( __( 'Edit', 'booking' ) ).'\' href=\'' . $visitorbookingediturl . '\' ><i class=\'wpbc_icn_draw\'></i></a>';
							$header_title .= '<a class=\'btn btn-default wpbc_btn_in_timeline\' title=\''. esc_js( __( 'Cancel', 'booking' ) ).'\'  href=\'' . $visitorbookingcancelurl . '\' ><i class=\'wpbc_icn_delete_outline\'></i></a>';
							$header_title .= '<a class=\'btn btn-default wpbc_btn_in_timeline\' title=\''. esc_js( __( 'Pay', 'booking' ) ).'\'  href=\'' . $visitorbookingpayurl . '\' ><i class=\'wpbc_icn_forward_to_inbox\'></i></a>';
						}
					}
				}
